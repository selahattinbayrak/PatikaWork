...
public class UçakBiletiFiyatHesaplama {
    public static void main(String[] args) {
        ...
        double mesafeUcret=0.10, gidisDönüşİndirimi=0,toplamTutar=0,normalTutar;
        ...
        if ((mesafe>0 & yas>0) & (yolculukTipi>=1 && yolculukTipi<=2)){
            ...
            if (yolculukTipi==2){
                gidisDönüşİndirimi=toplamTutar*gidişDönüşInd;
                toplamTutar=(toplamTutar-gidisDönüşİndirimi)*2;
            }
